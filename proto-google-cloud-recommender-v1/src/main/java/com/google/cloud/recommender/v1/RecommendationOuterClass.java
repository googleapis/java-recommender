  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "ct.proto\032\037google/protobuf/timestamp.proto\032\027google/type/money.proto\"\376\007\n"
          ...
          + "\021additional_impact\030\006 \003(\0132#.google.cloud.recommender.v1.Impact\022C\n"
          ...
          + "ogle.cloud.recommender.v1.Recommendation.InsightReference\032#\n"
          ...
          + "mmender}/recommendations/{recommendation}\022afolders/{folder}/locations/{location}"
          + "/recommenders/{recommender}/recommendations/{recommendation}\022morganizations/{org"
          + "anization}/locations/{location}/recommen"
          + "ders/{recommender}/recommendations/{recommendation}\"^\n"
          ...
          + " \001(\0132+.google.cloud.recommender.v1.CostProjectionH\000\"`\n"
          + "\010Category\022\030\n"
          ...
          + "\005state\030\001"
          + " \001(\0162:.google.cloud.recommender.v1.RecommendationStateInfo.State\022_\n"
          + "\016state_metadata\030\002 \003(\0132G.google.cloud.recommender.v1"
          + ".RecommendationStateInfo.StateMetadataEntry\0324\n"
          ...
          + "\037com.google.cloud.recommender.v1P\001ZFgoogle.golang.org/genproto/googleapis/cloud/"
          + "recommender/v1;recommender\242\002\004CREC\252\002\033Google.Cloud.Recommender.V1\352A\317\002\n"
          + "&recommender.googleapis.com/Recommender\022Bprojects/{p"
          + "roject}/locations/{location}/recommenders/{recommender}\022QbillingAccounts/{billin"
          + "g_account}/locations/{location}/recommenders/{recommender}\022@folders/{folder}/loc"
          + "ations/{location}/recommenders/{recommender}\022Lorganizations/{organization}/locat"
          + "ions/{location}/recommenders/{recommender}b\006proto3"
    };
    descriptor =
