...
public final class InsightOuterClass {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          + ".google/cloud/recommender/v1beta1/insight.proto\022 google.cloud.recommender.v1bet"
          + "a1\032\031google/api/resource.proto\032\036google/pr"
          + "otobuf/duration.proto\032\034google/protobuf/s"
          + "truct.proto\032\037google/protobuf/timestamp.proto\"\213\010\n"
          + "\007Insight\022\014\n"
          ...
          + "\022observation_period\030\005 \001(\0132\031.google.protobuf.Duration\022F\n\n"
          + "state_info\030\006 \001(\01322.goo"
          + "gle.cloud.recommender.v1beta1.InsightStateInfo\022D\n"
          + "\010category\030\007"
          + " \001(\01622.google.cloud.recommender.v1beta1.Insight.Category\022\014\n"
          + "\004etag\030\013 \001(\t\022e\n"
          + "\032associated_recommendations\030\010"
          + " \003(\0132A.google.cloud.recommender.v1beta1.Insight.RecommendationReference\0321\n"
          ...
          + "MANAGEABILITY\020\004:\371\002\352A\365\002\n"
          + "\"recommender.googleapis.com/Insight\022Vprojects/{pro"
          + "ject}/locations/{location}/insightTypes/{insight_type}/insights/{insight}\022ebilli"
          + "ngAccounts/{billing_account}/locations/{location}/insightTypes/{insight_type}/in"
          + "sights/{insight}\022Afolders/{folder}/locations/{location}/insightTypes/{insight_ty"
          + "pe}\022Morganizations/{organization}/locati"
          + "ons/{location}/insightTypes/{insight_type}\"\271\002\n"
          + "\020InsightStateInfo\022G\n"
          + "\005state\030\001 \001(\01628"
          + ".google.cloud.recommender.v1beta1.InsightStateInfo.State\022]\n"
          + "\016state_metadata\030\002 \003(\013"
          + "2E.google.cloud.recommender.v1beta1.InsightStateInfo.StateMetadataEntry\0324\n"
          ...
          + "$com.google.cloud.recommender.v1beta1P\001ZKgoogle.golang.org/genproto/googleapis"
          + "/cloud/recommender/v1beta1;recommender\242\002\004CREC\252\002"
          + " Google.Cloud.Recommender.V1Beta1\352A\323\002\n"
          + "&recommender.googleapis.com/InsightType\022Cprojects/{project}/locations/{loca"
          + "tion}/insightTypes/{insight_type}\022RbillingAccounts/{billing_account}/locations/{"
          + "location}/insightTypes/{insight_type}\022Afolders/{folder}/locations/{location}/ins"
          + "ightTypes/{insight_type}\022Morganizations/{organization}/locations/{location}/insi"
