  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "ogle/protobuf/duration.proto\032\034google/protobuf/struct.proto\032\037google/protobuf/timestamp.proto\032\027google/type/money.proto\"\227\010\n"
          ...
          + "\021additional_impact\030\006"
          + " \003(\0132(.google.cloud.recommender.v1beta1.Impact\022H\n"
          + "\007content\030\007"
          + " \001(\01327.google.cloud.recommender.v1beta1.RecommendationContent\022M\n\n"
          + "state_info\030\n"
          + " \001(\01329.google.cloud.recommender.v1beta1.RecommendationStateInfo\022\014\n"
          + "\004etag\030\013 \001(\t\022^\n"
          + "\023associated_insights\030\016"
          + " \003(\0132A.google.cloud.recommender.v1beta1.Recommendation.InsightReference\032#\n"
          ...
          + "mmenders/{recommender}/recommendations/{recommendation}\022morganizations/{organiza"
          + "tion}/locations/{location}/recommenders/{recommender}/recommendations/{recommendation}\"c\n"
          ...
          + "operations\030\001 \003(\0132+.google.cloud.recommender.v1beta1.Operation\"\353\004\n"
          + "\tOperation\022\016\n"
          + "\006action\030\001 \001(\t\022\025\n\r"
          + "resource_type\030\002 \001(\t\022\020\n"
          ...
          + "\005value\030\007 \001(\0132\026.google.protobuf.ValueH\000\022G\n\r"
          + "value_matcher\030\n"
          + " \001(\0132..google.cloud.recommender.v1beta1.ValueMatcherH\000\022R\n"
          + "\014path_filters\030\010"
          + " \003(\0132<.google.cloud.recommender.v1beta1.Operation.PathFiltersEntry\022_\n"
          + "\023path_value_matchers\030\013"
          + " \003(\0132B.google.cloud.recommender.v1beta1.Operation.PathValueMatchersEntry\032J\n"
          ...
          + "\003key\030\001 \001(\t\022=\n"
          + "\005value\030\002"
          + " \001(\0132..google.cloud.recommender.v1beta1.ValueMatcher:\0028\001B\014\n\n"
          + "path_value\":\n"
          ...
          + "\010duration\030\002 \001(\0132\031.google.protobuf.Duration\"\212\002\n"
          + "\006Impact\022C\n"
          + "\010category\030\001"
          + " \001(\01621.google.cloud.recommender.v1beta1.Impact.Category\022K\n"
          + "\017cost_projection\030d"
          + " \001(\01320.google.cloud.recommender.v1beta1.CostProjectionH\000\"`\n"
          + "\010Category\022\030\n"
          ...
          + "\005state\030\001"
          + " \001(\0162?.google.cloud.recommender.v1beta1.RecommendationStateInfo.State\022d\n"
          + "\016state_metadata\030\002"
          + " \003(\0132L.google.cloud.recommender.v1beta1.RecommendationStateInfo.StateMetadataEntry\0324\n"
          ...
          + "$com.google.cloud.recommender.v1beta1P\001ZKgoogle.golang.org/genproto/googlea"
          + "pis/cloud/recommender/v1beta1;recommender\242\002\004CREC\252\002"
          + " Google.Cloud.Recommender.V1Beta1\352A\317\002\n"
          + "&recommender.googleapis.com/Recommender\022Bprojects/{project}/locations/{l"
          + "ocation}/recommenders/{recommender}\022QbillingAccounts/{billing_account}/locations"
          + "/{location}/recommenders/{recommender}\022@folders/{folder}/locations/{location}/re"
          + "commenders/{recommender}\022Lorganizations/{organization}/locations/{location}/reco"
